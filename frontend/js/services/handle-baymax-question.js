const baymaxUrl = "http://salab3rt.ddns.net:8080/baymax/api/ask-baymax";
const baymaxImageUrl = "http://salab3rt.ddns.net:8080/baymax/api/show-baymax"; // separate endpoint for image
